...
import entity.dto.AnnotationMemberEntityDTO;

import java.io.IOException;

public class AnnotationMemberEntityDTOAdapter extends TypeAdapter<AnnotationMemberEntityDTO> {

  private final AdditionalBinDTOAdapter additionalBinDTOAdapter;
  private final LocationDTOAdapter locationDTOAdapter;

  public AnnotationMemberEntityDTOAdapter() {
    this.additionalBinDTOAdapter = new AdditionalBinDTOAdapter();
    this.locationDTOAdapter = new LocationDTOAdapter();
  }

  @Override
  public void write(JsonWriter out, AnnotationMemberEntityDTO value) throws IOException {
    out.beginObject();
  ...
  @Override
  public AnnotationMemberEntityDTO read(JsonReader in) throws IOException {
    AnnotationMemberEntityDTO res = new AnnotationMemberEntityDTO();
    in.beginObject();
    while (in.hasNext()) {
      switch (in.nextName()) {
        case "external":
